...
Este código fuente sirve como proyecto para la experiencia educativa de sistemas inteligentes. Se trata de la creación de un clasificador de imagenes usando Python y Tensorflow.
